...
{
    internal sealed class NadaOuterFlamesEffect :
        MonoBehaviour,
        ...
        INadaResolvedStateReceiver
    {
        ...
        private static readonly Color BlackFlameColor =
            new Color(0.04f, 0.025f, 0.06f, 1f);
        ...
        private readonly Dictionary<int, ParticleSystem.MinMaxCurve>
            _baseStartLifetime = new();

        private readonly Dictionary<int, float>
            _baseSimulationSpeed = new();

        private readonly Dictionary<int, bool>
            _baseSizeOverLifetimeEnabled = new();

        private readonly Dictionary<int, ParticleSystem.MinMaxCurve>
            _baseSizeOverLifetime = new();
            ...
            foreach (ParticleSystem particleSystem in _systems)
            {
                        ...
                        particleSystemId))
                {
                    try
                    {
                        ...
                        _baseSizeOverLifetimeEnabled[
                            particleSystemId] =
                            sizeOverLifetime.enabled;

                        _baseSizeOverLifetime[
                            particleSystemId] =
            ...
            float scale)
        {
            ...
            float scaleMultiplier =
                ClampScale(scale) *
                OuterFlamesVisualScaleMultiplier;
        ...
        private static ParticleSystem.MinMaxGradient
            ParticleSystemGradientFromColor(
                Color color)
        {
